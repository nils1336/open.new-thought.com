  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        ressourcenBeratungMittelstand: resolve(__dirname, 'site/ressourcen/ki-beratung-mittelstand.html'),
        ressourcenChangeManagement: resolve(__dirname, 'site/ressourcen/change-management-ki-einfuehrung.html'),
        ressourcenImMittelstand: resolve(__dirname, 'site/ressourcen/ki-im-mittelstand.html'),
        ressourcenTransformation: resolve(__dirname, 'site/ressourcen/ki-transformation.html'),
